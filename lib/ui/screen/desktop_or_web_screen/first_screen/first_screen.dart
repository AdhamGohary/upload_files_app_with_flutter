...
import 'package:upload_files/ui/screen/desktop_or_web_screen/first_screen/first_screen_functions/first_screen_functions.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          'Run As Web App',
          style: TextStyle(
              fontSize: 0.03 * getWidth(context: context), color: Colors.black),
        ),
      ),
      body: ListView(
        children: [
            ...
            child: Row(
              ...
              children: [
                ...
                Container(
                  ...
                  margin:
                      EdgeInsets.only(left: 0.04 * getWidth(context: context)),
          ...
          Padding(
            padding: EdgeInsets.symmetric(
                horizontal: 0.4 * getWidth(context: context)),
